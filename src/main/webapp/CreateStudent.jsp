  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
      ...
      <nav class="col-lg-2 sidebar" id="sidebar">
        ...
        <a href="CreateStudent.jsp" class="active"><i class="bi bi-person-plus"></i> Create Student</a>
          ...
          <form action="./savestudent" method="post">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" id="mobile" name="mobileNumber" required>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" id="aadhaar" name="aadhaarNumber" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="number" step="0.01" class="form-control" id="tenthMark" name="tenthMark" required>
              </div>
              <div class="col-md-6 mb-3">
                <label for="twelveMark" class="form-label">12th Marks (%):</label>
                <input type="number" step="0.01" class="form-control" id="twelveMark" name="twelveMark" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="number" step="0.01" class="form-control" id="gradMark" name="gradMark" required>
              </div>
            </div>
